...
<li><b>notAnotB</b> - number of genes not in any gene list.</li>

<li><b>inAnotB</b> - number of genes in the user\'s uploaded gene list (list A) but not in the current database gene list being analyzed (list B).</li>
<li><b>inBnotA</b> - number of genes in the current database gene list (list B) but not in the user uploaded gene list (list A).</li>
<li><b>inBinA</b> - number of genes in both the current database gene list and the user uploaded gene list.</li>
