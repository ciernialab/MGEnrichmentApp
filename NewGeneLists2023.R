...
##################################################################################
load("/Users/aciernia/Sync/CierniaLabMembers/AnnieCiernia/Experiments/IMM/tissueRNAseq/GeneListEnrichments/MGEnrichmentApp-main/Mouse_Human_GenelistDatabaseAugust2021.RData")
...
genes_human = getBM(attributes = c("ensembl_gene_id","hgnc_symbol",  "entrezgene_id"),
                    mart = human)
...
#merge in human data
tmp <- merge(humanlist1,genes_human,by.x="GeneID", by.y="hgnc_symbol")
...
CDB2.1 <- merge(CDBt, genes_human, by.x="HGNC.symbol", by.y= "hgnc_symbol")
